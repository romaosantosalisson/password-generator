...
Uma aplicação web simples, moderna e intuitiva projetada para ajudar você a criar senhas fortes e aleatórias com apenas um clique.

## ✨ Funcionalidades

- **Gerar Senhas:** Cria instantaneamente duas senhas seguras de 15 caracteres.
